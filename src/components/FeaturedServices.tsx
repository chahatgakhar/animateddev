  ...
  return (
    ...
    <div>
        <div className="text-center">
            ...
            <p className="mt-2 text-2xl leading-8 font-extrabold tracking-tight text-white sm:text-4xl">We are here to help</p>
        </div>
    </div>
                ...
                <div key={service.id} className="flex justify-center">
                    ...
                    className="flex flex-col rounded-[22px] bg-white dark:bg-zinc-900 overflow-hidden h-full max-w-sm">
                        <div className="p-4 sm:p-6 flex flex-col items-center text-center flex-grow">
                            ...
                            <Link href={`/services/${service.slug}`} className='text-base pt-2 text-neutral-400 dark:text-neutral-600'>
                            Learn More
                            </Link>
                        </div>
                    </BackgroundGradient>
